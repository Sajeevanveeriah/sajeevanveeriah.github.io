...
const routes = ["/blog/the-experience-trap/","/blog/machine-vision-starts-with-the-image/","/blog/automation-queues-and-flow-time/",'/', '/about/', '/notes/', '/blog/', '/blog/ai-without-the-jargon/', '/work/', '/work/autonomous-navigation-rover/', '/work/ataxia-assessment-device/', '/work/swl-pricing-inventory-control/']
