...
try {
  ...
  await page.getByRole("searchbox").fill("Gendio");
  ...
  assert.equal(await page.getByRole("status").textContent(), "21 projects");
  ...
  assert.equal(await plain.locator(".catalogue article").count(), 21);
