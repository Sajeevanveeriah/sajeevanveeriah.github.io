...
export const employers: readonly Employer[] = [
  {
    /*
     * Current independent practice. Saj confirmed on 6 August 2026 that the
     * four projects below are completed, deployed and used by end-users.
     * The records in `projects.ts` carry the full public evidence boundaries.
    ...
    claims: [
      {
        ...
        tier: 'delivered',
        body: 'I designed, built and deployed Upzy, a supervised, privacy-conscious browser application for young children that is now used by end-users for adult-defined routines, simple child-facing prompts and adult review while keeping button interactions separate from proof that an activity occurred.',
      },
      {
        discipline: 'Networks and data',
        tier: 'delivered',
        body: 'I designed, implemented and deployed a controlled local-first browser and Windows desktop application that is used by end-users to compare supplier and ServiceM8 exports, apply a confirmed 30% markup on cost, route exceptions and proposals through operator review, and produce import, change, exception, rollback and audit outputs.',
      },
      {
        discipline: 'Robotics and autonomy',
        tier: 'delivered',
        body: 'I designed, built and deployed an operator-support mobile robot that is now used by end-users to assist physical inventory scanning and connect captured stock observations to a controlled review workflow.',
      },
      {
        discipline: 'Robotics and autonomy',
        tier: 'delivered',
        body: 'I designed, built and deployed a modular robot platform that is now used by end-users for supervised education, engineering experiments and repeatable subsystem testing, with clear interfaces and honest separation between demonstration and validated performance.',
      },
    ],
    summary:
